...
public class SudokuSolver1 {
    ...
    private void solveZeros(List<Pair<Integer, Integer>> solvable) {
        ...
        for (Pair pair : solvable) {
            ...
            int sol = findSolution(row, column);
            if (sol != 0) {
    ...
    public void solve() {
        ...
        if (getArrayStyleString(solution).contains("0")) {
            solve();
        }
    }


    private int findSolution(int row, int column) {
    ...
    public static void main(String[] args) {
        SudokuSolver1 sudokuSolver = new SudokuSolver1();
